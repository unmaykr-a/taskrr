...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Centered via -translate-x/y-1/2. The open/close motion is a clean,
        // traditional *vertical* rise: it stays horizontally centred
        // (slide-from-left-1/2 == the resting x, so no sideways motion) and
